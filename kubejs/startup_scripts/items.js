onEvent("item.registry", (event) => {
  ...
  item("lost_page_everbright", "Lost Page", 64);
  item("lost_page_undergarden", "Lost Page", 64);
  item("lost_page_everdawn", "Lost Page", 64);
  item("lost_page_twilight", "Lost Page", 64);
  item("lost_page_nether", "Lost Page", 64);
  item("lost_page_blueleaf", "Lost Page", 64);
