onEvent('recipes', event => {
  new recipes(event)
    .removeIds([
      ...
      'butchercraft:beef_scraps_to_ground',
      'butchercraft:cooked_beef_scraps_to_ground',
      'butchercraft:pork_scraps_to_ground',
      'butchercraft:cooked_pork_scraps_to_ground',
      'butchercraft:lamb_scraps_to_ground',
      'butchercraft:cooked_lamb_scraps_to_ground',
      ...
      // "rankine:tin_block",
      // "rankine:tin_nugget",
      // "rankine:tin_ingot_from_tin_block",
      // "rankine:tin_ingot_from_tin_nugget",
    ...
    .removeConfigs([
      ...
      {
        output: 'coinsje:copper_coin',
        input: 'coinsje:iron_coin',
      },
      {
        output: 'butchercraft:bbq_jar_item',
      ...
      {output: 'minecraft:hopper', input: '#forge:ingots/aluminum'},
      {
      ...
      {output: 'minecraft:painting', input: '#minecraft:wool'},
      {
        output: 'paragon_textiles:wicker',
        input: 'minecraft:sugar_cane',
      },
      ...
      {output: 'minecraft:jukebox', input: 'minecraft:diamond'},
      {
        output: '/rankine:bronze_.*/',
        input: 'rankine:brass_ingot',
      },
      {input: 'minecraft:clay_ball', output: 'minecraft:brick'},
      ...
      {output: '#create:seats', input: '#minecraft:wool'},
      {
        output: 'productivebees:spawn_egg_configurable_bee',
        type: 'tconstruct:casting_table',
      },
    ])
    // TODO: Stage 7.1, 7.2, 8
    .removeOutputs(['#im:stage_7_1', '#im:stage_7_2', '#im:stage_8']);
  ...
  filtered_recipe_types.forEach(recipe_type => {
    event.remove({type: recipe_type});
  });
});
