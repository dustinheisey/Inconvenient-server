...
onEvent("recipes", (event) => {
  ...
  //   event.remove({
  //     output: Item.of("twilightforest:ironwood_chestplate", "{Damage:0}").enchant(
  //       "minecraft:protection",
  //       1
  //     ),
  //   });
  //   event.remove({
  //     output: Item.of("twilightforest:ironwood_leggings", "{Damage:0}").enchant(
  //       "minecraft:protection",
  //       1
  //     ),
  //   });
  ...
  //   });
  //   event.remove({
  //     output: Item.of("twilightforest:steeleaf_chestplate", "{Damage:0}").enchant(
  //       "minecraft:blast_protection",
  //       2
  //     ),
  //   });
  //   event.remove({
  //     output: Item.of("twilightforest:steeleaf_leggings", "{Damage:0}").enchant(
