  ...
  new recipes(event)
    ...
    .modifyOutputs([
      ...
      },
      {
        ...
        inputs: ["minecraft:netherite_ingot", "malum:soul_stained_steel_sword"],
      },
      {
      ...
      },
      {
        ...
        inputs: ["minecraft:netherite_ingot", "malum:soul_stained_steel_boots"],
      },
      {
        output: "twilightforest:fiery_ingot",
        inputs: ["twilightforest:fiery_blood", "twilightforest:steeleaf_ingot"],
      },
      {
