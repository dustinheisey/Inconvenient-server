...
onEvent("recipes", (event) => {
    function stageRecipes(stage, targets) {
    ...
    stageRecipes("stage_5_1", [
        ...
        {
            output: ["blue_skies:trough", "#minecraft:wool"],
            or: [
                { type: "minecraft:crafting_shaped" },
                { type: "minecraft:crafting_shapeless" },
            ],
