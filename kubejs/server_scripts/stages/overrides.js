...
onEvent("tags.items", (event) => {
  function overrideStages(mod, config) {
    Object.keys(config).forEach((stage) => {
      config[stage].forEach((override) => {
        stages.forEach((stage) => {
          event.remove(`im:${stage}`, override);
        });
        event.add(`im:${stage}`, override);
      });
    });
  }

  overrideStages("chipped", {
    stage_5_1: ["chipped:loom_table"],
    stage_7_1: [
  ...
  overrideStages("relics", {
    ...
    stage_3: [
      ...
      "relics:scarab_talisman",
      "relics:spider_necklace",
      "relics:magic_mirror",
      "relics:leather_belt",
      "relics:hunter_belt",
      "relics:arrow_quiver",
    ...
    stage_4: [
      ...
      "relics:horse_flute",
      "relics:wool_mitten",
      "relics:camouflage_ring",
      "relics:ghost_skin_talisman",
      "relics:delay_ring",
    ],
    stage_7_1: [
    ...
    stage_7_2: ["relics:infinity_ham"],
  });
  overrideStages("productivebees", {
    stage_5_1: [
  ...
  overrideStages("tconstruct", {
    stage_1: ["tconstruct:husk_head"],
    stage_2: [
  ...
  overrideStages("ecofriendly", {
    ...
    stage_2: ["ecofriendly:recycled_carrier_bag_ym"],
    stage_3: [
  ...
  overrideStages("realistictorches", {
    stage_3: ["realistictorches:glowstone_crystal"],
    stage_4: ["realistictorches:glowstone_paste"],
  });
  overrideStages("delightful", {
    stage_1: [
      "delightful:acorn",
    ...
    stage_7_2: ["delightful:emerald_knife"],
  });
  overrideStages("architects_palette", {
    stage_1: [
  ...
  overrideStages("rankine", {
    ...
    stage_3: [
      ...
      "rankine:basalt_bricks_pressure_plate",
      ...
      "rankine:quartzite_button",
      "rankine:siltstone_button",
    ...
    stage_7_1: [
      ...
      "rankine:petrified_chorus_pressure_plate",
  ...
  overrideStages("paraglider", {
    stage_2: ["paraglider:deku_leaf"],
    stage_4: ["paraglider:goron_goddess_statue"],
    stage_7: [
  ...
  overrideStages("naturesaura", {
    ...
    stage_7_2: ["naturesaura:outpost_finder"],
  });
  overrideStages("chunkloaders", {
    stage_3: ["chunkloaders:single_chunk_loader"],
  });
  overrideStages("farmingforblockheads", {
    stage_7_2: ["farmingforblockheads:market"],
  });
  overrideStages("farmersrespite", {
    stage_3: ["farmersrespite:tea_curry"],
    stage_4: [
  ...
  overrideStages("minecraft", {
    ...
    stage_5: ["minecraft:ender_pearl", "minecraft:ender_eye"],
    stage_5_1: [
      "minecraft:wheat",
    ...
    stage_7_2: ["minecraft:emerald_block", "minecraft:emerald"],
  });
  overrideStages("butchercraft", {
    stage_1: ["butchercraft:brain"],
    stage_3: ["butchercraft:cooked_brain"],
  });
  overrideStages("kubejs", {
    stage_1: [
    ...
    stage_5_1: [
      "kubejs:stripped_hide",
      "kubejs:antibiotics_bucket",
      "kubejs:feed_mix",
      "kubejs:pre_mix",
    ],
    stage_5_2: ["kubejs:catalyst"],
  });
  overrideStages("undergarden", {
    stage_3: ["undergarden:gloom_o_lantern"],
  });
  overrideStages("immersiveengineering", {
    stage_2: [
    ...
    stage_7_1: ["immersiveengineering:ersatz_leather"],
  });
  overrideStages("immersivepetroleum", {
    stage_4: ["immersivepetroleum:crudeoil_bucket"],
  });
  overrideStages("immersive_aircraft", {
    stage_5_1: ["immersive_aircraft:airship"],
  });
  overrideStages("extendedcrafting", {
    stage_2: ["extendedcrafting:handheld_table"],
    stage_3: [
  ...
  overrideStages("endrem", {
    stage_1: ["endrem:cold_eye", "endrem:undead_soul"],
    stage_2: ["endrem:exotic_eye", "endrem:guardian_eye"],
    stage_3: ["endrem:corrupted_eye", "endrem:undead_eye", "endrem:rogue_eye"],
    stage_4: ["endrem:black_eye", "endrem:wither_eye"],
    stage_5_1: ["endrem:cursed_eye"],
    stage_5_2: ["endrem:lost_eye"],
    stage_6: ["endrem:nether_eye"],
    stage_7_1: ["endrem:cryptic_eye"],
  });
  overrideStages("comforts", {
    stage_1: ["comforts:sleeping_bag_white"],
    stage_2: ["comforts:sleeping_bag_red"],
  });
  overrideStages("balanced_crates", {
    stage_4: ["balanced_crates:crimson_crate", "balanced_crates:warped_crate"],
  });
  overrideStages("create", {
    stage_1: [
      "create:asurine",
      "create:limestone",
      "create:ochrum",
    ...
    stage_7_1: ["create:crushed_raw_osmium"],
  });
  overrideStages("createaddition", {
    stage_5_1: [
  ...
  overrideStages("constructionwand", {
    stage_4: [
      "constructionwand:diamond_wand",
      "constructionwand:infinity_wand",
    ],
  });
  overrideStages("cold_sweat", {
    stage_1: [
      "cold_sweat:hearth",
    ...
    stage_4: ["cold_sweat:soulspring_lamp"],
    stage_5_1: ["cold_sweat:minecart_insulation"],
  });
  overrideStages("charcoal_pit", {
    stage_2: [
      ...
      "charcoal_pit:sandy_slab",
      "charcoal_pit:sandy_stair",
      "charcoal_pit:sandy_wall",
  ...
  overrideStages("blue_skies", {
    ...
    stage_5_1: ["blue_skies:ventium_milk_bucket"],
  });
  overrideStages("chemlib", {
    stage_4: [
    ...
    stage_5_1: ["chemlib:sodium_dust", "chemlib:sodium_plate"],
    stage_5_2: [
  ...
  overrideStages("adpother", {
    stage_2: ["adpother:polluted_water_bucket"],
    stage_5_2: ["adpother:aerometer"],
  });
  overrideStages("cataclysm", {
    stage_2: [
    ...
    stage_7_1: ["cataclysm:ignitium_elytra_chestplate"],
  });
  overrideStages("hexerei", {
    stage_1: [
    ...
    stage_5_1: ["hexerei:milk_bottle"],
    stage_7_1: ["hexerei:crystal_ball"],
  });
  overrideStages("paragon_textiles", {
    stage_1: ["paragon_textiles:plant_fibers"],
    stage_2: [
  ...
  overrideStages("smallships", {
    ...
    stage_4: ["smallships:cannon", "smallships:cannon_ball"],
  });
  overrideStages("pneumaticcraft", {
    stage_5_1: [
  ...
  overrideStages("farmersdelight", {
    ...
    stage_7_1: ["farmersdelight:diamond_knife"],
  });
  overrideStages("biomancy", {
    stage_1: ["biomancy:flesh_blob_spawn_egg", "biomancy:living_flesh"],
  });
  overrideStages("brewinandchewin", {
    stage_1: ["brewinandchewin:jerky"],
    stage_2: ["brewinandchewin:salty_folly"],
  });
  overrideStages("mekanism", {
    stage_1: ["mekanism:block_salt", "mekanism:salt"],
  });
  overrideStages("thirst", {
    stage_4: ["thirst:sand_filter"],
  });

  event.remove("im:stage_1", [
    "rankine:blueschist_bricks_slab",
    "rankine:mossy_blueschist_bricks",
    "rankine:stainless_steel_block",
    "rankine:nickel_superalloy_block",
