onEvent("server.datapack.high_priority", (event) => {
    addAdvancements(event, "stage_5_1", {
        icon: "honeycomb",
        item: "botania:mana_spreader",
        title: "Age 5: Agriculture",
...

                    {
                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                title: "Earth Rune",
                                description:
                                    "Create a rune of earth in a runic altar",
                                frame: "goal",
                                children: [
                                    {
