onEvent("server.datapack.high_priority", (event) => {
    addAdvancements(event, "stage_5_2", {
        icon: "immersiveengineering:wirecoil_copper",
        item: "createaddition:alternator",
        title: "Age 5: Industry",
                        ...
                        children: [
                            {
                                ...
                                children: [
                                    ...
                                    },
                                    {
                                        ...
                                        description:
                                            "Construct a pressure chamber",
                                        children: [
                                            {
                                                item: "pneumaticcraft:etching_acid_bucket",
                                                title: "Etching Acid",
                                                description:
                                                    "Create a bucket of etching acid",
                                                children: [
                                                    {
                            ...
                            },
                            {
                                ...
                                children: [
                                    ...
                                    },
                                    {
                                        ...
                                        description:
                                            "Craft a steel mechanical component",
                                        children: [
                                            {
                                                item: "immersiveengineering:heavy_engineering",
                                                title: "Heavy Engineering",
                                                description:
                                                    "Craft a heavy engineering block",
                                                children: [
                                                    {
                                        ...
                                        children: [
                                            {
                                                ...
                                                description:
                                                    "Craft an iron mechanical component",
                                                children: [
                                                    {
                                                        item: "immersiveengineering:light_engineering",
                                                        title: "Light Engineering",
                                                        description:
                                                            "Craft a light engineering block",
                                                    },
                                                ],
                                            },
                                            {
                                                ...
                                                title: "Vacuum Tube",
                                                description:
                                                    "Create an vacuum tube",
                                                children: [
                                                    {
                                                        item: "create:precision_mechanism",
                                                        title: "Precision Mechanism",
                                                        description:
                                                            "Create a precision mechanism",
                                                        frame: "goal",
                                                        children: [
                                                            {
